...
class CNNBiLSTMDistinguisher(nn.Module):
    def __init__(self):
        super(CNNBiLSTMDistinguisher, self).__init__()
        self.conv1 = nn.Conv1d(1, 64, kernel_size=3, padding=1)
        self.relu = nn.ReLU()
        self.lstm = nn.LSTM(input_size=64, hidden_size=64, num_layers=1, bidirectional=True, batch_first=True)
